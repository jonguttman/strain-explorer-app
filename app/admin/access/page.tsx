  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="mx-auto max-w-5xl px-4 py-8 space-y-6">
        ...
        <div className="rounded-xl border border-slate-200 bg-white/90 shadow-sm p-6 space-y-3">
          ...
          <div className="space-y-4">
            <div>
              ...
              <ul className="space-y-2 text-sm text-slate-700">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-amber-600 mt-0.5">•</span>
                  <span>Generate QR codes for each access link</span>
                </li>
              </ul>
            </div>
            ...
            <div className="pt-2 border-t border-slate-100">
              <p className="text-xs text-slate-500">
                <span className="font-medium">Note:</span> For now, you can still use{" "}
                <code className="rounded bg-slate-100 px-1.5 py-0.5 font-mono text-slate-700">
                  /?key=master
                </code>{" "}
                as your testing link while we finish this panel.
              </p>
            </div>
          </div>
        </div>
